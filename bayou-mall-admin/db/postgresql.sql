...
INSERT INTO sys_user (user_id, username, password, salt, email, mobile, status, create_user_id, create_time) VALUES ('1', 'admin', '9ec9750e709431dad22365cabc5c625482e574c74adaebba7dd02f1129e4ce1d', 'YzcmCZNvbXocrsz9dm8e', 'root@bayou', '13890735927', '1', '1', '2016-11-11 11:11:11');
...
INSERT INTO sys_menu(menu_id, parent_id, name, url, perms, type, icon, order_num) VALUES (5, 1, 'SQL监控', 'http://localhost:8080/bayou-fast/druid/sql.html', NULL, 1, 'sql', 4);
...
INSERT INTO schedule_job (bean_name, params, cron_expression, status, remark, create_time) VALUES ('testTask',  'bayou', '0 0/30 * * * ?', '0', '参数测试', '2016-12-01 23:16:46');


-- 账号：13890735927  密码：admin
INSERT INTO tb_user (username, mobile, password, create_time) VALUES ('mark', '13890735927', '8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918', '2017-03-23 22:37:41');
